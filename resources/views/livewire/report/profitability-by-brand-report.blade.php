<div>
    <div class="px-4 sm:px-6 lg:px-8 py-8 w-full max-w-9xl mx-auto">
        <x-page-header>
            Laporan Profitabilitas per Merek
        </x-page-header>
                ...
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full dark:text-gray-300">
                            ...
                            <tr>
                                <th class="p-2 whitespace-nowrap"><div class="font-semibold text-left">Nama Merek</div></th>
                                <th class="p-2 whitespace-nowrap"><div class="font-semibold text-center">Total Item Terjual</div></th>
                                <th class="p-2 whitespace-nowrap"><div class="font-semibold text-right">Total Pendapatan</div></th>
                                <th class="p-2 whitespace-nowrap"><div class="font-semibold text-right">Total Laba Kotor</div></th>
                            </tr>
                            </thead>
                            <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
                            @forelse($profitabilityByBrand as $data)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/20">
                                    <td class="p-2">
                                        <div class="font-semibold text-gray-800 dark:text-gray-100">{{ $data->brand_name }}</div>
                                    </td>
                                    <td class="p-2">
                                        <div class="text-center">{{ (int)$data->total_items_sold }}</div>
                                    </td>
                                    <td class="p-2">
                                        <div class="text-right">Rp {{ number_format($data->total_revenue, 0, ',', '.') }}</div>
                                    </td>
                                    <td class="p-2">
                    ...
                    <div class="mt-4 px-3">
                        {{ $profitabilityByBrand->links('components.pagination-numeric') }}
                    </div>
                </div>
            </div>
        </div>
