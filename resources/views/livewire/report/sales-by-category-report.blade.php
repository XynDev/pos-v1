        ...
        <div class="space-y-6">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg border border-gray-200 dark:border-gray-700 flex flex-col">
                ...
                <div class="p-3">
                    <div class="overflow-x-auto">
                        <table class="table-auto w-full dark:text-gray-300">
                            ...
                            <tr>
                                ...
                                <th class="p-2 whitespace-nowrap"><div class="font-semibold text-right">Total Penjualan</div></th>
                            </tr>
                            </thead>
                            <tbody class="text-sm divide-y divide-gray-100 dark:divide-gray-700/60">
                            @forelse($salesByCategory as $data)
                                <tr class="hover:bg-gray-50 dark:hover:bg-gray-900/20">
                                    <td class="p-2">
                                        <div class="font-semibold text-gray-800 dark:text-gray-100">{{ $data->category_name }}</div>
                                    </td>
                                    <td class="p-2">
                    ...
                    <div class="mt-4 px-3">
                        {{ $salesByCategory->links('components.pagination-numeric') }}
                    </div>
                </div>
            </div>
        </div>
