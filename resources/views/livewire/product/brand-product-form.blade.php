<div
    ...
    style="display: none;"
>
    {{-- Latar belakang overlay dengan animasi fade --}}
    <div
        x-show="show"
                ...
                <form>
                    ...
                    <header class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg leading-6 font-semibold text-gray-800 dark:text-gray-100" id="modal-title">
                            {{ $isEditMode ? 'Edit Merek' : 'Buat Merek Baru' }}
                        </h3>
                    </header>
                    ...
                    <div class="bg-white dark:bg-gray-800 p-6 space-y-4">
                        <div>
                            <label for="brand_name" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Nama Merek</label>
                            <input type="text" id="brand_name" placeholder="Masukkan Nama Merek" wire:model.live="name" class="form-input w-full dark:bg-gray-700/50 dark:border-gray-600 dark:text-gray-200">
                            @error('name') <span class="text-red-500 text-xs mt-1">{{ $message }}</span>@enderror
                        </div>
                        <div>
                            <label for="brand_slug" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Slug</label>
                            <input type="text" id="brand_slug" wire:model="slug" readonly class="form-input w-full bg-gray-100 dark:bg-gray-700 dark:border-gray-600 dark:text-gray-400 cursor-not-allowed">
