                ...
                <form>
                    <header class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg leading-6 font-semibold text-gray-800 dark:text-gray-100" id="modal-title">
                            {{ $isEditMode ? 'Edit Atribut' : 'Buat Atribut Baru' }}
                        </h3>
                    </header>

                    <div class="bg-white dark:bg-gray-800 p-6 space-y-4">
                        <div>
                            <label for="attribute_name" class="block text-sm font-medium text-gray-600 dark:text-gray-300 mb-1">Nama Atribut</label>
                            <input type="text" id="attribute_name" placeholder="Contoh: Ukuran atau Warna" wire:model.defer="name" class="form-input w-full dark:bg-gray-700/50 dark:border-gray-600 dark:text-gray-200">
